...
SECRET_KEY = '$#-_l_cp!ifu3&o5g^0(ne_p!-0o$y!(v))@$2rr$q!@hivmpn'
...
print( config('HOST_EMAIL_USER'))
#EMAIL_HOST_USER = 'rottenpotato123@gmail.com'
#EMAIL_HOST_PASSWORD= 'sadjdcsnowewmhdm'
